...
def reproject_dataset ( dataset, \
    ...
    (urx, ury, ulz ) = tx.TransformPoint( geo_t[0] + geo_t[1]*x_size, geo_t[3])
    (llx, lly, lrz ) = tx.TransformPoint( geo_t[0], \
                                      geo_t[3] + geo_t[5]*y_size )
    ...
    dest = mem_drv.Create('', (int((urx - llx)/pixel_spacing)), \
                          int((ury - lly)/pixel_spacing), 1, gdal.GDT_Int16)
...
dataset = 'HDF4_EOS:EOS_GRID:"/home/faizan/China_land_cover/shellscript/MOD09A1.A2005281.h27v04.005.2008073184016.hdf":MOD_Grid_500m_Surface_Reflectance:sur_refl_b01'

dest = reproject_dataset(dataset)

newRasterfn="MOD09A1.A2005281.h27v04.005.2008073184016.tif"
...
gdal_dataset = gdal.Open("/home/faizan/China_land_cover/shellscript/MOD09A1.A2005281.h27v04.005.2008073184016.hdf")
