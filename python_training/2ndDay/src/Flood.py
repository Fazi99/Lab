...
n=0
with open('/home/faizan/USA_data/8days/pak_data/list.txt',"r") as f:
    #g=len(f.readlines())     #print sum(1 for _ in f)
    for line in f:
        l= line.split(".")
        #assigning names
        red_b=path+str(l[0])+"."+str(l[1])+".sur_refl_b01.tif"
        nir_b=path+str(l[0])+"."+str(l[1])+".sur_refl_b02.tif"
        blue_b=path+str(l[0])+"."+str(l[1])+".sur_refl_b03.tif"
        swir_b=path+str(l[0])+"."+str(l[1])+".sur_refl_b06.tif"
        #ndvi=path+str(l[2])+"."+str(l[1])+".US"+".ndvi.tif"
        evi=path+str(l[0])+"."+str(l[1])+".evi.tif"
        lswi=path+str(l[0])+"."+str(l[1])+".lswi.tif"
        #dvel=path+str(l[2])+"."+str(l[1])+".US"+".dvel.tif"
        #flood=path+str(l[2])+"."+str(l[1])+".US"+".flood.tif"
        ...
        print n
        n +=1
        del EVI, LSWI, red, blue, nir, SWIR
f.close()
